...
<div class="portfolio-wrapper">
    <div class="main-card">
        ...
        <!-- ===== CERTIFICATES WITH EXACT IMAGE NAMES ===== -->
        <h2 class="section-title"><i class="fas fa-certificate"></i> Certificates & Credentials</h2>
        <div class="cert-grid">
            <!-- Digital Literacy -->
            <div class="cert-card">
                <img src="20260823_d0aae0.png" alt="Digital Literacy Certificate" />
            ...
            <!-- Python Programming -->
            <div class="cert-card">
                <img src="20260823_df15e5.png" alt="Python Programming Certificate" />
            ...
            <div class="cert-card">
                <img src="20260823_7c823c.png" alt="Android Fundamentals Certificate" />
            ...
            <!-- C++ for Beginners -->
            <div class="cert-card">
                <img src="20260823_9a719e.png" alt="C++ for Beginners Certificate" />
